...
- Provides AI assistants to select and execute the best AI agent for your task.
...
Installer requires only `curl` available:
    ...
    curl -fsSL https://raw.githubusercontent.com/raas-dev/configent/1.131.0/install.sh | sh
