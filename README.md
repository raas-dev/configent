...
Installer requires only `curl` available:
    ...
    curl -fsSL https://raw.githubusercontent.com/raas-dev/configent/1.70.11/install.sh | sh
...
5. AppSec container vulnerability scanners and AWS and Azure development tools
