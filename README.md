...
- Multiplexing terminal where Rust and Go written utils are preferred for speed
...
**Note: The script overrides your current dotfiles at $HOME without prompting.**
    ...
    curl -fsSL https://raw.githubusercontent.com/raas-dev/configent/1.16.2/install.sh | sh
