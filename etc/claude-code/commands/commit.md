---
description: Generate a single conventional commit message based on the input you will receive.
---
...
<output>
You MUST generate a single conventional commit message based on the input:
