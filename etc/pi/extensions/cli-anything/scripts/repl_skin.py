...
Usage:
    ...
    skin = ReplSkin("shortcut", version="1.0.0")
...
_ACCENT_COLORS = {
    ...
    "shortcut":     "\033[38;5;35m",    # teal green
}
...
class ReplSkin:
    ...
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        Args:
            software: Software name (e.g., "gimp", "shortcut", "blender").
...
_ANSI_256_TO_HEX = {
    ...
    "\033[38;5;35m":  "#00af5f",  # shortcut teal
