...
If you change the prompt to handle a tricky failure mode (e.g., a repeated failed edit or an unexpected tone shift), add a short note to `README.md`’s version history describing what was fixed and why.
